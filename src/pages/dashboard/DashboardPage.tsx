...
import { BookOpen, Eye, TrendingDown, TrendingUp, Users } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border border-border p-6 rounded-lg bg-card">
          ...
          <ChartContainer
            config={{
              freePlan: { label: "Free Plan", color: "hsl(var(--chart-1))" },
              proPlan: { label: "Pro Plan", color: "hsl(var(--chart-2))" },
